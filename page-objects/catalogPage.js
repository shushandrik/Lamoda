class CatalogPage {
  constructor(page) {
    ...
    this.filterItem = async (nameFilterItem) => `//div[@class='_item_2zwbo_2']//span[text()='${nameFilterItem}']`; // page.locator("._item_2zwbo_2");
    ...
    this.productCardBrandName = page.locator(`div[class='x-product-card-description__brand-name _brandName_k0rqx_6']`); // возможно точки между классами надо
    ...
    this.quickViewButton = page.locator('._quickView_1pjd5_67'); // возможно ховер надо сначала
    this.showMoreButton = page.locator('._showMore_z1yqr_2');
    this.nextPageButton = page.locator('_nextPage_7g9n8_74');
    //this.productsizeintoProductPage = page.locator (`//div[@class='_colspan_1widv_150 ui-product-page-sizes-chooser-item_enabled ui-product-page-sizes-chooser-item']`); //перенес
    //this.openSizeButtonProductPage = page.locator(`//div[@class= '_placeholder_1widv_51 _placeholderDisabled_1widv_98']`);//перенес
    //this.addToCartButton = page.locator(`div[class='recaptcha _recaptcha_sztd3_7']`); // перенес
    //this.goToCartProductPage = page.locator ('.d-modal__bottom a'); //перенес
